...
function generateAllCosts() {
  ...
  pricesToSend +="\n PREZZO RIVENDITORE: " + new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'EUR' }).format(costoRivenditore) + " IVA esclusa";
  pricesToSend +="\n PREZZO INSEGNISTA: " +  new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'EUR' }).format(costoInsegnista) + " IVA esclusa";
  pricesToSend +="\n PREZZO INSTALLATORE: " +  new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'EUR' }).format(costoInstallatore) + " IVA esclusa";
  pricesToSend +="\n PREZZO AL PUBBLICO: " + new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'EUR' }).format(costoClienteFinale) + " IVA esclusa";



  $("#sogliaMinima").text( new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'EUR' }).format(totalPrice) + " IVA esclusa");

  $("#clienteFinale").text( new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'EUR' }).format(costoClienteFinale) + " IVA esclusa");


  $("#installatore").text(new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'EUR' }).format(costoInstallatore) + " IVA esclusa");


  $("#insegnista").text(new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'EUR' }).format(costoInsegnista) + " IVA esclusa");


  $("#rivenditore").text( new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'EUR' }).format(costoRivenditore) + " IVA esclusa");
