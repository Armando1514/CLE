...
function createConsequenceMisuraCostaLateraleLuceRiflessaEvent() {
    ...
    if (step2Storage['Materiale costa laterale'] === 'Alluminio') {
        ...
        radioButtonInputGeneratorOnChange(selector, 'grezzo', field4, "Bianco naturale", createConsequenceVerniciaturaLuceRiflessaColorSelectedEvent);
    ...
    if (step2Storage['Materiale costa laterale'] === 'Alluminio') {
        ...
        if (step2Storage['Tipologia profilo'] === 'Letter form') {
          ...
          radioButtonInputGeneratorOnChange(selector, "verniciata", field4, "Verniciata", createConsequenceVerniciaturaEvent)
            ...
            radioButtonInputGeneratorOnChange(selector, 'grezzo', field4, "Bianco naturale", createConsequenceColorVerniciaturaCostaLateraleSelected);
            radioButtonInputGeneratorOnChange(selector, "verniciata", field4, "Verniciata", createConsequenceVerniciaturaEvent);
        }
...
function consequenceLettereSingoleIndipendenti() {
    ...
    let field1 = "Dicitura scritta";
    let field2 = "Tipologia di font";
    let field3 = "Stessa altezza in cm";
  ...
  createTitle('.step1', "dicituraScrittaEqual", "Tutte le lettere della stessa altezza (OPZIONALE) : ");
...
function generateInputForEachLetter(letterString) {
    ...
    while (i < size) {
        ...
        $("<input/>", {
            ...
            value: $("input[name='Stessa altezza in cm']").val() ,
