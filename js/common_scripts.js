...
$.extend($.validator, {
	...
	messages: {
		...
		range: $.validator.format("Inserisci un valore compreso fra {0} e {1}."),
		max: $.validator.format("Inserisci un valore più piccolo o uguale di {0}."),
		min: $.validator.format("Inserisci un valore più piccolo o uguale di {0}.")
	},
