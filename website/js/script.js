		...
		if (plugins.rdMailForm.length) {
			var i, j, k,
				msg = {
					...
					'MF001': 'Non inviata!',
					'MF002': 'Form non funziona in locale!',
					'MF003': 'Definisci una e-mail valida!',
					'MF004': 'Inserisci i campi corretti!',
					'MF254': 'Qualcosa è andato storto!',
					'MF255': 'Qualcosa non ha funzionato.'
				};
				...
				$form.attr('novalidate', 'novalidate').ajaxForm({
					...
					beforeSubmit: function (arr, $form, options) {
						...
						if (isValidated(inputs, captcha)) {
							...
							if (output.hasClass("snackbars")) {
								output.html('<p><span class="icon text-middle fa fa-circle-o-notch fa-spin icon-xxs"></span><span>Invio</span></p>');
								output.addClass("active");
							}
						} else {
							return false;
